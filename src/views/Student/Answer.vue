      ...
      <transition name="slider-fade">
        <div class="left" v-if="slider_flag">
          ...
          <div class="l-bottom">
            ...
            <div class="final" @click="commit()">Finish exam</div>
          </div>
        </div>
      </transition>
      <!--右边选择答题区-->
      <transition name="slider-fade">
        <div class="right">
          <div class="title">
            ...
            <span>Total  {{ topicCount[0] + topicCount[1] + topicCount[2] }}  questions  <i
                class="iconfont icon-time"></i>Countdown： <b>{{ time }}</b>  Minutes</span>
          </div>
          <div class="content">
            ...
            <div class="fill" v-if="currentType === 2">
              <div v-for="(item,currentIndex) in part" :key="currentIndex">
                <el-input placeholder="Please fill in here"
          ...
          <div class="operation">
            <ul class="end">
              <li @click="previous()"><i class="iconfont icon-previous"></i><span>Last</span></li>
...
export default {
  ...
  methods: {
    ...
    mark() { //标记功能
      let questionIsMark = this.topic[this.currentType][this.index]["isMark"];

      if (questionIsMark === true) {
        this.topic[this.currentType][this.index]["isMark"] = false
      }
      else if (questionIsMark === false || questionIsMark === undefined) {
        this.topic[this.currentType][this.index]["isMark"] = true
      }

      // workaround for re-rendering list
      this.topic[this.currentType].push("")
      this.topic[this.currentType].pop()
