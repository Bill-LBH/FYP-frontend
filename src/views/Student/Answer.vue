      ...
      <transition name="slider-fade">
        <div class="right">
          <div class="title">
            ...
            <span>Total  {{topicCount[0] + topicCount[1] + topicCount[2]}}  questions  <i class="iconfont icon-time"></i>Countdown： <b>{{time}}</b>  Minutes</span>
          </div>
          <div class="content">
            ...
            <div v-if="currentType == 1">
              ...
              <div class="analysis" v-if="isPractice">
                <ul>
                  <li> <el-tag type="success">Answer：</el-tag><span class="right">{{reduceAnswer.rightAnswer}}</span></li>
                  <li><el-tag>Analysis：</el-tag></li>
            ...
            <div class="fill" v-if="currentType == 2">
              ...
              <div class="analysis" v-if="isPractice">
                <ul>
                  <li> <el-tag type="success">Answer：</el-tag><span class="right">{{topic[2][index].answer}}</span></li>
                  <li><el-tag>Analysis：</el-tag></li>
            ...
            <div class="judge" v-if="currentType == 3">
              ...
              <div class="analysis" v-if="isPractice">
                <ul>
                  <li> <el-tag type="success">Answer：</el-tag><span class="right">{{topic[3][index].answer}}</span></li>
                  <li><el-tag>Analysis：</el-tag></li>
