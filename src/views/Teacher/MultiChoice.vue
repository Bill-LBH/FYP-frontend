<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="answera" label="Answer A" width="140">
      </el-table-column>
      <el-table-column prop="answerb" label="Answer B" width="140">
      </el-table-column>
      <el-table-column prop="answerc" label="Answer C" width="140">
      </el-table-column>
      <el-table-column prop="answerd" label="Answer D" width="140">
      </el-table-column>
      <el-table-column prop="rightanswer" label="Right answer" width="140">
      </el-table-column>
